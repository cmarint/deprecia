app.controller('calcController',
     function ($scope, $http, $ionicModal, $stateParams, $ionicLoading, $ionicPopup, factoria) {

         var oControl = this;
        oControl.Fact = factoria;
         ...
         $scope.datos.rangeValue3 = 1;
          ...
          oControl.enviarMail = function (datos) {
            ...
            oControl.Fact.sendMail({
            "vidaUtil": $scope.datos.vidautil,
            "antiguedad": $scope.datos.antiguedad,
            "valorNuevo": $scope.datos.valornuevo,
            "valorResidual": $scope.datos.valorresidual,
            "condicionesFisicas": $scope.datos.condiciones,
            ...
            .error(function (data) {
                ...
                oControl.error = data.ExceptionMessage;
            });
        }
        ...
        $scope.setGrafico = function() {
            ...
            rossh = oControl.fDep_RossHeidecke(vidautil, antiguedad, condiciones, valornuevo, valorresidual);
            fitto = oControl.fDep_FittoCorvini(vidautil, antiguedad, condiciones, valornuevo, valorresidual);
            lineal = oControl.fDep_Lineal(vidautil, antiguedad, condiciones, valornuevo, valorresidual);
        ...
        oControl.setAntiguedad = function(data) {
            vidautil = $scope.datos.vidautil;
            rango = data/vidautil*100;
            $scope.datos.rangeValue = parseInt(rango);
            $scope.setGrafico();
            console.log('Valor antiguedad cambiado');
        }

        oControl.setRangoVidaUtil = function() {
            vidautil = $scope.datos.vidautil;
            rango = $scope.datos.rangeValue;
            antiguedad = (rango/100)*vidautil;
        ...
        oControl.setResidual = function(data) {
            valornuevo = $scope.datos.valornuevo;
            rango = data/valornuevo*100;
            $scope.datos.rangeValue2 = parseInt(rango);
            $scope.setGrafico();
            console.log('Valor residual cambiado');
        }


        oControl.setRangoResidual = function() {
            valornuevo = $scope.datos.valornuevo;
            rango = $scope.datos.rangeValue2;
            valorresidual = (rango/100)*valornuevo;
            $scope.datos.valorresidual = valorresidual;
            $scope.setGrafico();
        }
        /*$scope.$watch('datos.rangeValue2',function(val,old){
            valornuevo = $scope.datos.valornuevo;
            valorresidual = (val/100)*valornuevo;
            $scope.datos.valorresidual = valorresidual;
            $scope.setGrafico();
    ...
    // An alert dialog
    oControl.showAlert = function() {
     var alertPopup = $ionicPopup.alert({
       title: 'Información',
       template: 'Mail enviado correctamente!'
     });
